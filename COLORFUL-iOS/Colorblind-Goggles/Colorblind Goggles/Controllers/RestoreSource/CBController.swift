...
open class CBController: NSObject, UIActionSheetDelegate {
    ...
    @objc public func startColorBlinds() {
        if timer != nil {
...
//        }
        timer = Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(CBController.updateScreen), userInfo: nil, repeats: true)
//        timer = Timer.sc
    }
